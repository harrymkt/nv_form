...
`bool create_window(string &in window_title, bool change_screen_title = true, bool say_dialog = true, bool silent = false);`

## Arguments:
- `string &in window_title`: The title of the window.
