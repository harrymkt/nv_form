...
Assign the menu to the `menu` property of any control and the form opens it for you. You do not call `show` yourself unless you want to open the menu from somewhere else.
